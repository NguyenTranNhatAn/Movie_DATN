  ...
  const loadUserData = async () => {
    try {
      ...
      if (storedToken) {
        ...
        const response = await fetch(`http://103.69.193.223:3006/api/user-info`, {
...
const styles = StyleSheet.create({
  ...
  legendColorOtherSelected: {
    width: 15,
    height: 15,
    backgroundColor: 'gray', // Màu vàng cho ghế của người dùng khác
    marginRight: 5,
  },
  legendColorSelected: {
    width: 15,
